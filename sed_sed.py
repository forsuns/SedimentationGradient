...
def main():
    ...
    flucMin, flucMax, cStep = -1e-3, 5e-3, 1e-5
    csort = 10
    ...
    contour = plot_contour(ax, avg_data, vel1, xmin, xmax, ymin, ymax, flucMin, flucMax, cStep, csort)
    ...
    plt.title('Sedimentation Rate', fontsize=16)
    ...
    plt.savefig('ss41_sed.png', dpi=200, bbox_inches='tight')
    plt.show()
